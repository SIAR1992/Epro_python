...
starter = ColorSaver(allLabelUser) # Kalder classen, der hedder ColorSaver, inde holder moduler, som henter og gemmer farver fra tidligere gemte labels og nye dannede labels
